          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid items-center gap-8 lg:grid-cols-2">
              ...
              <div className="">
                ...
                >
                  ABOUT SOFTINTURN SOLUTIONS
                </div>
                <h1
                  data-aos="fade-up"
                  className="mb-6 heading-2 text-start font-bold tracking-tight text-gray-900 md:text-5xl lg:text-6xl"
                >
                  How We Make A Difference IT Solution
                  <span className=" text-primary"> IT Solutions</span> IT
                  Solutions
                </h1>
                <p
                  data-aos="fade-up"
                ...
                >
                  With expertise spanning custom software development,
                  full-stack web development, mobile app development, machine
                  learning solutions, artificial intelligence development, cloud
                  computing services, and data analytics and business
                  intelligence, we empower businesses to thrive in the digital
                  age. Our collaborative approach, combined with cutting-edge
                  technology and a results-driven mindset, ensures that we
                  deliver customized solutions that meet the unique needs and
                  objectives of our clients. Let us help you unlock the full
                  potential of technology and achieve your business goals with
                  confidence. From IT strategy consulting and comprehensive
                  technology roadmaps to the end-to-end development of scalable
                  solutions, Softinturn Solutions delivers a full-cycle software
