  ...
  return (
    <>
      <div id="banner" className="h-screen relative">
        ...
        <div className="pt-[3rem] wrapper flex items-center h-full">
          ...
          >
            ...
            <Link to="/about-us" className="primary-btn mt-2">
              ABOUT US
            </Link>
          </div>
        </div>
        ...
        <div className="flex flex-col-reverse items-center lg:grid grid-cols-2 gap-10 mt-7">
          <div data-aos="fade-right" className="flex h-full flex-col gap-7">
            <div className="flex flex-col gap-7 text-center lg:text-start">
              ...
              <p className="desc">
                At Softinturn Solutions, we help businesses unlock their full
                potential with a comprehensive suite of technology services.
                With expertise spanning custom software development, full-stack
                web development, mobile app development, machine learning
                solutions, artificial intelligence development, cloud computing
                services, and data analytics and business intelligence, we
                empower businesses to thrive in the digital age. From IT
                strategy consulting and comprehensive technology roadmaps to the
                end-to-end development of scalable solutions, Softinturn
                Solutions delivers a full-cycle software development services
      ...
      <section
        ...
        className="py-[3rem] bg-white text-black"
      >
        <div
          data-aos-offset={-400}
        ...
        >
          ...
          <p className="desc max-w-[50rem] mx-auto">
            At SOFTINTURN, we understand that your website is more than just an
